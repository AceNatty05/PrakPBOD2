...
public class DosenTamu extends Dosen{
    ...
    // kosntruktor
    public DosenTamu(String NIP, String Nama, LocalDate TanggalLahir, LocalDate TMT, double GajiPokok, String Fakultas, String NIDK){
    ...
    public void printInfo(){
        ...
        System.out.println("Tanggal Akhir Kontrak: " + FormatTanggalIndonesia(getAkhirKontrak()));
        System.out.println("Gaji Pokok: " + FormatRupiah(getGajiPokok()));
        System.out.println("Tunjangan: " + getPersenTunjangan()*100 + "% x " + FormatRupiah(getGajiPokok()) + " = " + getTunjangan());
    }
}